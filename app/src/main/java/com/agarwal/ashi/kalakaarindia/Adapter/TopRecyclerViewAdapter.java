...
public class TopRecyclerViewAdapter extends RecyclerView.Adapter<TopRecyclerViewAdapter.MyViewHolder> {
    ...
    public TopRecyclerViewAdapter(Listener listener, List<Categories> categories){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view=LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.top_recycler_view_item, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder,final int i) {
        ...
        Glide.with(myViewHolder.itemView.getContext()).load(categories.get(i).getImage())
                .into(myViewHolder.category_image_view);
        myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                listener.onTopRecyclerViewItemClicked(categories.get(i).getName());
